...
import OTPOperator from '../../../screens/OTPOperator/OTPOperator.jsx';
...
import AddServicesRequest from "../../../screens/AddServicesRequest/AddServicesRequest.jsx";
import AddServicesOperator from "../../../screens/AddServicesOperator/AddServicesOperator.jsx";
import Dashboard1 from "../../../screens/Dashboard1/Dashboard1/Dashboard1";
import ServiceHistory from "../../../screens/ServiceHistory/ServiceHistory/ServiceHistory.jsx";
// Chandan Sir
...
import ProfileSettingOperator from "../../../screens/ProfileSettingsOperator/ProfileSettingOpertor";
  ...
  <MainWrapper>
    <main>
      <Switch>
        ...
        <Route exact={true} path="/OTPOperator" render={(props) => <Drawer page={<OTPOperator />} />}/>
        {/* <Route exact={true} path="/otp" component={OTPAdmin} /> */}
        ...
        <Route path="/AddServicesRequest" exact={true} render={(props) => <Drawer page={<AddServicesRequest />} />}/>
        <Route path="/AddServicesOperator" exact={true} render={(props) => <Drawer page={<AddServicesOperator />} />}/>
        <Route path="/Dashboard1" exact={true} render={(props) => <Drawer page={<Dashboard1 />} />}/>
        <Route path="/ServiceHistory" exact={true} render={(props) => <Drawer page={<ServiceHistory />} />}/>
        {/* Chandan Sir */}
        ...
        {<Route path="/ProfileSettingOperator" render={props => <Drawer page={<ProfileSettingOperator />} />} />}
