...
// components
import styles from './ProfileSettingOpertor.module.css';
...
export function ProfileSettingOperator(props) {
          ...
          {/* Information Tab */}
            ...
            />
						...
						<div className={styles.textbox_hide}>
                            ...
                            For updating your profile please contact station admin
							</div>
						</div>
...
export default compose(connect(mapStateToProps, mapDispatchToProps))(ProfileSettingOperator);
