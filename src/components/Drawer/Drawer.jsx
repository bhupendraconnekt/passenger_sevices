    ...
    <div style={{color: 'white'}} className={classes.root}>
      ...
      >
        ...
        <Link to="/dashboard">
            ...
            <Link to="/dashboard1">
            <ListItem disableRipple={true} className={path == 'dashboard1' ? styles.active : styles.list} button>
              <ListItemIcon><img className={path == 'dashboard1' ? styles.selected : styles.filter } src={home} /></ListItemIcon>
              <ListItemText className={path == 'dashboard1' ? styles.selectedText : styles.listText } primary={"dashboard1"} />
            </ListItem>
            </Link>
          ...
          <Link to="/vendors-service">
            ...
            <ListItem disableRipple={true} className={path == 'service-history' ? styles.active : styles.list} button>
              <ListItemIcon><img className={path == 'service-history' ? styles.selected : styles.filter} src={users_cog} /></ListItemIcon>
              <ListItemText style={{ whiteSpace: open ? 'break-spaces': ""}} className={path == 'service-history' ? styles.selectedText : styles.listText} primary={"Service History"} />
            </ListItem>
            </Link>
        </List>
      </Drawer>
